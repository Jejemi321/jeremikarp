...
export const ModelsFromŁódź: PhotoPortfolioItemsType = {
	title: "ModelsFromŁódźTitle",
	description: "ModelsFromŁódźDescription",
	imageCover: "/assets/img/portfolio/photo/ModelsFromŁódź/05.webp",
	date: "2023-03-18",
	favorite: false,
	...
	imgArray: Array.from({ length: 15 }, (_, i) => ({
		...
		src: `/assets/img/portfolio/photo/ModelsFromŁódź/${String(i + 1).padStart(
			2,
			"0"
		)}.webp`,
	})),
